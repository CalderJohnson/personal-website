...
const Portfolio = () => {
  return (
    <div id="portfolio" className="portfolio-section max-w-4xl mx-auto px-4 py-8 mt-16 mobile:flex mobile:justify-center">
      <h2 className="mobile:hidden text-3xl text-[#1E293B] font-bold mb-4">My Projects</h2>
      <div className="md:grid md:grid-cols-3 md:gap-4">
        <h2 className="md:hidden text-3xl text-[#1E293B] font-bold mb-4">My Projects</h2>
        <Project
