...
const Contact = () => {
  ...
  return (
    <div id="contact" className="contact-section max-w-4xl mx-auto px-4 py-8 mt-16 flex flex-col items-center">
      ...
      <p className="text-lg text-white ml-2 mb-4">Feel free to reach out to me through any of the following channels, I'm always open to new opportunities for collaboration!</p>
